...
pub fn catalog() -> Vec<ToolDefinition> {
    vec![
        ...
        tool(
            "browser_evaluate",
            "Evaluate JavaScript",
            "Evaluate explicit bounded JavaScript in the page main world. It may read, mutate, or navigate the page.",
            evaluate_schema(),
            Hints::browser_action(true),
        ),
        tool(
            ...
            object(
                vec![
                    ...
                    (
                        ...
                        handle(
                            "target_",
                            "Optional current file input. Omit to return the GIF to the client.",
                        ),
                    ),
                ],
                vec!["action"],
