...
pub const PRESENTATION_CSS_SCRIPT: &str =
    include_str!("../../../../extension/lib/presentation-css.js");

pub const SHARED_SCRIPT: &str = include_str!("../../../../extension/lib/shared.js");
pub const FORM_DIAGNOSTICS_SCRIPT: &str =
    include_str!("../../../../extension/lib/form-diagnostics.js");
...
pub fn inject_glass(writer: &ghostlight_bridge::transport::SocketWriter) {
    ...
    let frame = ghostlight_bridge::browser::BrowserFrame::Request {
        request: ghostlight_bridge::browser::BrowserRequest {
            ...
            command: ghostlight_bridge::browser::BrowserCommand::SetPreloadScript { script },
        },
    };
