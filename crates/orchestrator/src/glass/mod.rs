...
pub const PRESENTATION_CSS_SCRIPT: &str = include_str!("../../../../extension/lib/presentation-css.js");
...
pub fn inject_glass(writer: &ghostlight_bridge::transport::SocketWriter) {
    let script = format!("(() => {{\n{}\n{}\n{}\n{}\n{}\n{}\n}})();", SHARED_SCRIPT, FORM_DIAGNOSTICS_SCRIPT, SENSOR_SCRIPT, PRESENTATION_CSS_SCRIPT, PRESENTATION_SCRIPT, CONTENT_SCRIPT);
