...
//! ([`crate::tool::script::run_batch`]), and returns the result in browser_batch's own trained shape
...
use crate::tool::script::{run_batch, single_surface_tab, BatchRun, PipelineRunner};
    ...
    Box::pin(async move {
        ...
        if !has_actions {
            return CallOutcome::Success {
                result: crate::tool::result::text_content(
...
mod tests {
    use super::*;
    use crate::tool::outcome::CallOutcome;
    use crate::tool::script::{run_batch, StepRunner};
