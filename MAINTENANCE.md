...
1. **Platform-package publishing** rides a single maintainer account. Mitigation intent: add a
   second organization owner and documented signing recovery before any extended coast.
