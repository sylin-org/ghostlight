...
- The final automated gate passed formatting, warnings-denied workspace Clippy, 301 orchestrator
  library tests, 10 orchestrator binary tests, 34 bridge tests, 6 MCP connector tests, 116 extension
  tests, an isolated workspace build, and the process, CLI, and workbench-surface journeys.
- The process coverage includes reconnect, ordinary work, recording, close, and disabled-launch
  recovery. The Rust coverage includes simultaneous recovery, ambiguous installations, sandboxed
