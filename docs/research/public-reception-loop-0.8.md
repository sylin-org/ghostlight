...
| --- | --- | --- | --- |
| Release | When v0.8.0 is public across the approved core channels | pending | - |
| 7 days | Seven full days after the release timestamp | pending | - |
| 30 days | Thirty full days after the release timestamp | pending | - |
...
Publishing this Discussion is a separate owner-gated action. A project-authored prompt is
distribution evidence. Replies become reception evidence only within the limits of what each
person voluntarily shares.
