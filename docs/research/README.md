...
| [21-client-tool-surface-discovery-2026-08.md](21-client-tool-surface-discovery-2026-08.md) | Vendor-paired client discovery: a complete Claude Cowork / Claude-in-Chrome capture, a filtered Codex desktop registry and stateful Chrome gateway, evidence limits, schema deltas, and architecture/evaluation inputs. No product decision. |
| [22-canonical-browser-operation-primer.md](22-canonical-browser-operation-primer.md) | Model-delight browser vocabulary, semantic/physical separation, readiness and result contracts, stateful adapter rules, migration map, and evaluation gates. Research input to accepted [ADR-0101](../adr/0101-adaptive-tool-surfaces-canonical-operations-and-browser-mechanisms.md). |
| [23-agent-plugins-v1-2026-08.md](23-agent-plugins-v1-2026-08.md) | Agent Plugins v1 package and governance model, cross-client discovery and lifecycle behavior, catalog boundaries, exact local-stdio constraints, Ghostlight architecture fit, user-delight opportunities, and evaluation gates. Research input only; no supported package is claimed. |
| [24-policy-surface-user-delight-2026-08.md](24-policy-surface-user-delight-2026-08.md) | The governed person's side of governance: what the workbench policy surface shows today, the eight questions users arrive with, and prior art from Tailscale's visual policy editor, Windows RSoP, chrome://policy, Apple supervision, IAM Access Analyzer, and VS Code's settings scopes. Research input to accepted [ADR-0122](../adr/0122-readable-policy-destination-and-authored-user-layer.md). |
