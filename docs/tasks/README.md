...
| --- | --- | --- | --- |
| [process-diagnostics](process-diagnostics/) | ADR-0145: one shared local diagnostics directory all three executables write bounded, content-free operational logs into, with a one-command merged human timeline | Batch opened; D1 next | 2026-08-29 |
