...
| --- | --- | --- | --- |
| [demo-press-key-diagnosis](demo-press-key-diagnosis/) | Why the foundry demo's press_key beat fails with a misleading disconnect sentence (diagnosis record, not an execution batch) | Root cause narrowed to an extension error frame rendered by the fallthrough; message capture next | 2026-08-24 |
