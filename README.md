...
**Extension state.** The Chrome Web Store serves Chrome adapter v0.7.1. Chrome adapter v0.7.1 covers
Ghostlight service versions v0.7.1-v0.7.3. Chrome adapter v0.8.0 is pending review. Chrome adapter
v0.8.0 covers Ghostlight service versions v0.8.x. Install the extension from the public listing. See
the full [adapter compatibility map](compatibility.json).
