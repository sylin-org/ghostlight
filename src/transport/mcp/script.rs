...
use crate::transport::mcp::outcome::{CallOutcome, LocalCtx, LocalFuture};
use crate::transport::mcp::pipeline::run_tool_call;
use crate::transport::mcp::refs::resolve_refs;
...
pub(crate) fn script_handler(ctx: LocalCtx<'_>) -> LocalFuture<'_> {
    Box::pin(async move {
        ...
        let mut result = crate::transport::mcp::types::text_content(text);
...
mod tests {
    ...
    fn clone_outcome(o: &CallOutcome) -> CallOutcome {
        match o {
            ...
            CallOutcome::Denied { message, source } => CallOutcome::Denied {
                ...
                source: match source {
                    crate::transport::mcp::outcome::DenialSource::Policy => {
                        crate::transport::mcp::outcome::DenialSource::Policy
                    }
                    crate::transport::mcp::outcome::DenialSource::Sacred => {
                        crate::transport::mcp::outcome::DenialSource::Sacred
                    }
                },
            },
    ...
    fn denied() -> CallOutcome {
        CallOutcome::Denied {
            ...
            source: crate::transport::mcp::outcome::DenialSource::Policy,
        }
    }
